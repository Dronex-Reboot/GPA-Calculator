...
;               :   - RIFQI HARI PUTRANTO               < TEKNIK KOMPUTER - 1806200192 - 12A>                                              |
;KELOMPOK       :   6A                                                                                                                     |
;TEMA           : GPA CALCULATOR                                                                                                           |
;------------------------------------------------------------------------------------------------------------------------------------------|
...
;                                                                                                                                          |
;                                                                                                                                          |
;                   Copyright (C) 2020 Dimas Wira Nugraha, Philipus Renaldy Kristian, Natalia Kristian, Rifqi Hari Putranto                |
;                                                                                                                                          |
;                                                                                                                                          |
...
;               5. https://www.daniweb.com/programming/software-development/threads/264646/help-read-text-from-txt-file-and-store-in-array |
;               6. https://www.elprocus.com/8086-assembly-language-programs-explanation/                                                   |
;               7. https://www.youtube.com/watch?v=MZSqvqMuUvw&feature=youtu.be                                                            |                 
;------------------------------------------------------------------------------------------------------------------------------------------|
...
.DATA
    ...
    MATKUL21 DB 13,10,13,10,"NILAI MATA KULIAH 1 : $"
    MATKUL31 DB 13,10,13,10,"NILAI MATA KULIAH 1 : $"
    MATKUL41 DB 13,10,13,10,"NILAI MATA KULIAH 1 : $"
    MATKUL51 DB 13,10,13,10,"NILAI MATA KULIAH 1 : $"
    BBTNILAI DB 13,10,13,10,"MASUKKAN BOBOT NILAI : $"
    NOTE1    DB 13,10,13,10,"DIHARAPKAN UNTUK MEMASUKKAN NILAI UNTUK INPUT NILAI JIKA DIJUMLAHKAN MENJADI 100$"
...
READ MACRO MSG            
        MOV BX,AX                                                    ; BUAT READ .TXT DAN SIMPAN KE VARIABLE
        MOV CX,99
        MOV DX,OFFSET MSG
        MOV AH,3FH
        INT 21H
